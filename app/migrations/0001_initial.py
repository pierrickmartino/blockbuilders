# Generated by Django 4.1.7 on 2023-11-07 13:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_link', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contractlink_positions', to='app.contract')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sys_creation_date', models.DateTimeField(auto_now_add=True)),
                ('sys_update_date', models.DateTimeField(auto_now=True)),
                ('contract', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contract_contractlinks', to='app.contract')),
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='wallet_contractlinks', to='app.wallet')),
            ],
            options={
