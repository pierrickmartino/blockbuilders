...
import { Select, SelectContent, SelectItemExtended, SelectTrigger, SelectValue } from "@/components/Select";
import { categoryTypes, policyTypes, priorities, ticketTypes, type Category, type PolicyType } from "@/data/wallet/schema";
