...
class app_Contract(ContractBase, table=True):
...
class ContractsPublic(SQLModel):
    data: list[ContractPublic]  # List of contracts
    count: int  # Total count of contracts


# This is a workaround to avoid circular imports
if TYPE_CHECKING:
    from models.blockchain import BlockchainPublic, app_Blockchain

from models.blockchain import BlockchainPublic
