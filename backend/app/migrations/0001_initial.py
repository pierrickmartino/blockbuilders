# Generated by Django 4.2.7 on 2024-06-28 07:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('standard', 'Standard'), ('fee', 'Fee'), ('suspicious', 'Suspicious'), ('collateral', 'Collateral')], default='standard', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_fiat_based', models.DecimalField(decimal_places=8, default=0, max_digits=15)),
